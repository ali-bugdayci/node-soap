...
Server.prototype._envelope = function(body, includeTimestamp) {
  ...
  var xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
    ...
    encoding +
    this.wsdl.xmlnsInEnvelope + " xmlns:a=\"http://www.w3.org/2005/08/addressing\">";
  ...
  var self = this;
  this.soapHeaders.forEach(function(soapHeader){
    var obj = {};
    obj[soapHeader.name] = soapHeader.value;
    header += self.wsdl.objectToXML(obj, soapHeader.name, soapHeader.ns, '', false, soapHeader.attr, null, null);
  });
  this.soapHeaders = [];
  if(header)
    xml += "<soap:Header>" + header + "</soap:Header>";
...
Server.prototype.addSOAPHeader = function(name, value, namespace, schema, attributes) {
  this.soapHeaders.push({name: name, value: value, ns: namespace, schema: schema, attr: attributes});
};
